...
void render::init( ) {
	...
	notifylogs = Font(XOR("Lucida Console"), 10, FW_DONTCARE, FONTFLAG_DROPSHADOW);
	gw = Font(XOR("undefeated"), 24, FW_MEDIUM, FONTFLAG_ANTIALIAS);
	watermark = Font(XOR("Verdana"), 12, FW_NORMAL, FONTFLAG_DROPSHADOW);
	nigga = Font(XOR("Verdana"), 12, FW_BOLD, FONTFLAG_DROPSHADOW);
	prediction = Font(XOR("Calibri"), 14, FW_NORMAL, FONTFLAG_ANTIALIAS | FONTFLAG_DROPSHADOW);
}
